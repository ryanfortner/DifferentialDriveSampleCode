...
public final class Constants {
  ...
  public static final class DriveConstants {
        ...
        // wheels
        public static final double kTrackwidthMeters = 0.0254 * (22.25);
        ...
        public static final double kLinearDistanceConversionFactor = (0.0254 * (1 / (kGearRatio * 2 * Math.PI * 0.0254 * (kWheelRadiusInches)) * 10));
    }
